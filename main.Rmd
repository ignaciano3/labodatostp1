...
viajes_organizado$dif_sec <- viajes_organizado$dif_horaria * 3600
viajes_organizado <- subset(viajes_organizado, select = -c(dif_horaria))
head(viajes_organizado, 100)
```

```{r}

viajes_organizado$dia_semana.x = wday(viajes_organizado$Fecha_Hora_despegue, label = TRUE, abbr = FALSE)
viajes_organizado$dia_semana.y = wday(viajes_organizado$Fecha_Hora_aterrizaje, label = TRUE, abbr = FALSE)
